...
namespace legacy\world\templates;
...
final class Area
{
     ...
     * @return array
     */
    #[ArrayShape(['pvp' => "false", 'break' => "false", 'place' => "false", 'hunger' => "bool", 'dropItem' => "bool", 'chat' => "bool", 'cmd' => "bool", 'tnt' => "false", 'consume' => "bool"])] public static function createBaseFlags(): array
    {
        return [
            'pvp' => false,
            'break' => false,
