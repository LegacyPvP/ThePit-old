...
namespace Legacy\ThePit\librairies\libasynql;

use InvalidArgumentException;
use pocketmine\plugin\PluginBase;
use pocketmine\utils\Terminal;
use pocketmine\utils\Utils;
use Legacy\ThePit\librairies\libasynql\base\DataConnectorImpl;
use Legacy\ThePit\librairies\libasynql\base\SqlThreadPool;
use Legacy\ThePit\librairies\libasynql\mysqli\MysqlCredentials;
use Legacy\ThePit\librairies\libasynql\mysqli\MysqliThread;
use Legacy\ThePit\librairies\libasynql\sqlite3\Sqlite3Thread;
